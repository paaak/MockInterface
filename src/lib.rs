// src/lib.rs
/*
 * Core library for MockInterface
 */
...
#[derive(Debug)]
pub struct MockInterfaceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MockInterfaceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MockInterface processing");
    
    let mut processor = MockInterfaceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MockInterfaceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MockInterfaceProcessor::new(false);
